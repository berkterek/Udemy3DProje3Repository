...
For new scene : Drag POLYGON - FPS/Prefabs/Bunny_targets                        -> Registers the bunny targets(all players)
                Drag POLYGON - FPS/Prefabs/recyle_spawning_objs_performance     -> Important for shooting
...
Control :<BR>
w,s,a,d -> walk + left shift -> run <BR>
space -> jumping , q -> 3rd view ,r -> reload , <BR>e -> picking up a intem  / x -> leave vehicle<BR><BR><BR>


Tank control : f -> changing weapon 

----------------------------------------------------------

Press : T  to spawn killer bunnies
